...
class AnalizadorLexicoSintactico:
    def __init__(self, root):
        ...
        self.color_fondo_text = "#FFFAF0"  # Fondo color crema
        self.color_boton = "#FFB6C1"  # Botón color rosa pastel
        self.color_boton_texto = "#FFF0F5"  # Texto del botón color lavanda
